...
export const EasterBunnyView: React.FC<RoleViewProps> = ({ players, onAction, onSkip }) => {
    ...
    return (
        <Box textAlign="center">
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>{t('games.werewolf.ui.easter_bunny.instruction')}</Typography>
