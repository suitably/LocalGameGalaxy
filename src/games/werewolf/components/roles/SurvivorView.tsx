...
export const SurvivorView: React.FC<RoleViewProps> = ({ onAction, onSkip, powerState }) => {
    ...
    return (
        <Box textAlign="center">
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>{t('games.werewolf.ui.survivor.instruction')}</Typography>
            <Button
                variant="contained"
                size="large"
                color="success"
