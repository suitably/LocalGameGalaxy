...
describe('tabletopReducer card handling', () => {
  ...
  it('stacks identical cards in hand and computes stackCount', () => {
    // Modify c1 and c2 to have same cardType 'Wood'
    ...
    // Draw second card (same cardType)
    ...
    // The top card (c2) should have stackCount = 2
  ...
  it('plays card from hand onto the board', () => {
    ...
    // 2. Play card from hand onto board
